  ...
  const handleRazorpayPayment = async () => {
    ...
    try {
      ...
      const options = {
        ...
        image: 'https://backend-prod-hjlerckip39sk4no.s3-accelerate.amazonaws.com/images/2025/10/25/0198d335-0585-7738-b404-2c3b98ca1098/wsa-_logo_7430fb77.jpg',
        order_id: order.id,
        ...
        notes: {
          ...
          property_id: booking.property._id,
        },
        theme: {
          color: '#FF385C',
        },
              ...
              <div className="card" style={{ padding: 'var(--spacing-xl)', marginBottom: 'var(--spacing-lg)' }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--spacing-md)' }}>
                  <label style={{ 
                    ...
                    background: paymentMethod === 'razorpay' ? 'var(--primary)10' : 'var(--bg-secondary)', 
                    ...
                    <div style={{ flex: 1 }}>
                      <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', marginBottom: '0.25rem' }}>
                        ...
                        <strong style={{ fontSize: '1.05rem' }}>Razorpay</strong>
                      </div>
